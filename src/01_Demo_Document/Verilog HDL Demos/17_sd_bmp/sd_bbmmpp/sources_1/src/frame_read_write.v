...
(*mark_debug="true"*)	output[BUSRT_BITS - 1:0]         rd_burst_len,               // to external memory controller,data length of the burst read request, not bytes
(*mark_debug="true"*)	output[ADDR_BITS - 1:0]          rd_burst_addr,              // to external memory controller,base address of the burst read request 
	...
	(*mark_debug="true"*)output[BUSRT_BITS - 1:0]         wr_burst_len,               // to external memory controller,data length of the burst write request, not bytes
	(*mark_debug="true"*)output[ADDR_BITS - 1:0]          wr_burst_addr,              // to external memory controller,base address of the burst write request 
...
//instantiate an asynchronous FIFO 写fifo
...
//instantiate an asynchronous FIFO 读FIFO
