...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/07_sd_test/sd_card_test/sd_card_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_card_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sd_card_test.tcl
