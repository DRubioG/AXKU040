...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/07_sd_test/sd_card_test/sd_card_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_card_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sd_card_test.tcl -notrace
