...
HD_PWD='D:/ax/ax7035/demo/08_ram_test/ram_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_test.tcl
