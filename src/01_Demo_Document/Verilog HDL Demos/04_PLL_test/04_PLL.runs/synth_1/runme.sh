...
HD_PWD='E:/ax/ku040/04_PLL_test/04_PLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_test.tcl
