...
HD_PWD='E:/ax/ku040/04_PLL_test/04_PLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pll_test.tcl -notrace
