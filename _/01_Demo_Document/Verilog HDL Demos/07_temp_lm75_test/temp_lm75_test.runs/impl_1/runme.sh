...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/06_temp_lm75_test/temp_lm75_test/temp_lm75_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_test.tcl -notrace
