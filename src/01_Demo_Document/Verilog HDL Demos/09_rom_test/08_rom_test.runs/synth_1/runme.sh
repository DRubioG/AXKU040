...
HD_PWD='E:/ax/ku040/rom_test/rom_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_test.tcl
