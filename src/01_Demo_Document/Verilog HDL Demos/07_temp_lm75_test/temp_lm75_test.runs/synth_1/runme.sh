...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/06_temp_lm75_test/temp_lm75_test/temp_lm75_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_test.tcl
