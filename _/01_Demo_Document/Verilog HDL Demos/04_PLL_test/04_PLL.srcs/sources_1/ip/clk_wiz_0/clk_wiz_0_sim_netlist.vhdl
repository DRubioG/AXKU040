...
-- Date        : Wed Jul  7 11:28:34 2021
-- Host        : DESKTOP-C3F5G4E running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/ax/AX7325_CD_20201209/demo/03_pll_test/pll_test/pll_test.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
-- Design      : clk_wiz_0
...
architecture STRUCTURE of clk_wiz_0_clk_wiz_0_clk_wiz is
  ...
  signal NLW_clkout3_buf_I_UNCONNECTED : STD_LOGIC;
...
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => NLW_clkout3_buf_I_UNCONNECTED,
      O => clk_out3
    );
