...
HD_PWD='e:/ax/ku040/gtwizard_ultrascale_0_ex/gtwizard_ultrascale_0_ex.runs/sys_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_clock.tcl
