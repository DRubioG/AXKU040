...
HD_PWD='E:/ax/ku040/07_i2c_eeprom_test/i2c_eeprom_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_eeprom_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_eeprom_test.tcl -notrace
