...
-- Date        : Thu Apr 29 15:30:50 2021
-- Host        : DESKTOP-0FF260C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/XilinxPrj/AXUK40/gt_test_5g/gth_ex/gth_ex.srcs/sources_1/ip/sys_clock/sys_clock_sim_netlist.vhdl
-- Design      : sys_clock
...
entity sys_clock_sys_clock_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of sys_clock_sys_clock_clk_wiz : entity is "sys_clock_clk_wiz";
end sys_clock_sys_clock_clk_wiz;

architecture STRUCTURE of sys_clock_sys_clock_clk_wiz is
  signal clk_in1_sys_clock : STD_LOGIC;
  signal clk_out1_sys_clock : STD_LOGIC;
  signal clkfbout_buf_sys_clock : STD_LOGIC;
  signal clkfbout_sys_clock : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_sys_clock,
      O => clkfbout_buf_sys_clock
    );
...
entity sys_clock is
  ...
  attribute NotValidForBitStream of sys_clock : entity is true;
end sys_clock;

architecture STRUCTURE of sys_clock is
begin
inst: entity work.sys_clock_sys_clock_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
