...
HD_PWD='D:/ax/ax7035/demo/07_rom_test/rom_test.runs/rom_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_ip.tcl
