...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/07_sd_test/sd_card_test/sd_card_test.runs/clk_ref_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_ref.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_ref.tcl
