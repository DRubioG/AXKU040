...
set rc [catch {
  ...
  add_files -quiet E:/ax/ku040/14_hdmi_out_test/hdmi_out_test.runs/synth_2/top.dcp
...
set rc [catch {
  ...
  create_report "impl_2_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file top_timing_summary_routed.rpt -rpx top_timing_summary_routed.rpx -warn_on_violation "
