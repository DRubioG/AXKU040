...
//assign {i2c_slave_dev_addr,i2c_slave_reg_addr,i2c_write_data} = lut_data;//查表，Sil9134寄存器地址
...
begin
	case(lut_index)
		8'd0: lut_data <= {8'h72,8'h08,8'h35};//9134
		8'd1: lut_data <= {8'h7a,8'h2f,8'h00};//9134
