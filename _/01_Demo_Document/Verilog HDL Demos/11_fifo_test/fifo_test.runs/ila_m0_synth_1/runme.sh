...
HD_PWD='D:/ax/ax7035/demo/09_fifo_test/fifo_test.runs/ila_m0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_m0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_m0.tcl
