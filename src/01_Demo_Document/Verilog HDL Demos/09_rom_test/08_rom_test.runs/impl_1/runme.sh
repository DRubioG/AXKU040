...
HD_PWD='E:/ax/ku040/rom_test/rom_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_test.tcl -notrace
