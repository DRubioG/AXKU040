...
HD_PWD='E:/XilinxPrj/AXU7EV/eth_logic_ku040_full/eth_test.runs/icmp_rx_ram_8_256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icmp_rx_ram_8_256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icmp_rx_ram_8_256.tcl
