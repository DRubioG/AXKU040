...
HD_PWD='D:/ax/ax7035/demo/08_ram_test/ram_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_test.tcl -notrace
