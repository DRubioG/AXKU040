...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/02_key_test/key_test/key_test.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log key_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_test.tcl -notrace
