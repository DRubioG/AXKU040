...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/02_key_test/key_test/key_test.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log key_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_test.tcl
