...
HD_PWD='D:/xilinx_fpga/ku040/eeprom/eeprom/eeprom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_eeprom_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_eeprom_test.tcl
