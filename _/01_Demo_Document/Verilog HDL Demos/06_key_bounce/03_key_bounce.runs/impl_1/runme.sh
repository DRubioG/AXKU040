...
HD_PWD='E:/AX7325_CD_20201209/demo/05_key_debounce/key_debounce/key_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_debounce.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_debounce.tcl -notrace
