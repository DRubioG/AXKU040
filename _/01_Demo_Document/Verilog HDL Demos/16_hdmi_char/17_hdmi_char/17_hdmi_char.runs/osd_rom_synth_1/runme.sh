...
HD_PWD='E:/ax/AX7325_CD_20201209/demo/12_1_hdmi_char/hdmi_char/hdmi_char.runs/osd_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log osd_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source osd_rom.tcl
