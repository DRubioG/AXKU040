...
HD_PWD='D:/ax/ax7035/demo/09_fifo_test/fifo_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_test.tcl
