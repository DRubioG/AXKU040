...
HD_PWD='E:/AX7325_CD_20201209/demo/05_key_debounce/key_debounce/key_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_debounce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_debounce.tcl
