...
HD_PWD='D:/ax/ax7035/demo/09_fifo_test/fifo_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_test.tcl -notrace
