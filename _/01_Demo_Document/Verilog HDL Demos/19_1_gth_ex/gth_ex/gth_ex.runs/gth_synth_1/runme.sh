...
HD_PWD='E:/XilinxPrj/AXUK40/gt_test_12p5g/gth_ex/gth_ex.runs/gth_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gth.tcl
